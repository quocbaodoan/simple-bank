...
const (
	SimpleBank_CreateUser_FullMethodName  = "/db.SimpleBank/CreateUser"
	SimpleBank_UpdateUser_FullMethodName  = "/db.SimpleBank/UpdateUser"
	SimpleBank_LoginUser_FullMethodName   = "/db.SimpleBank/LoginUser"
	SimpleBank_VerifyEmail_FullMethodName = "/db.SimpleBank/VerifyEmail"
)
